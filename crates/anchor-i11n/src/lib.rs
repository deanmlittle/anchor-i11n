...
pub use anchor_i11n_derive::{TryFromAccountMetas, TryFromInstruction, AnchorDiscriminator};

pub mod prelude {
    pub use super::{
        TryFromAccountMetas, TryFromInstruction, Discriminator, AnchorDiscriminator
    };
}
...
mod tests {
    ...
    fn test_derive() {
        ...
        let mut accounts = vec![
            ...
            AccountMeta::new(pubkey!("7iWnBRRhBCiNXXPhqiGzvvBkKrvFSWqqmxRyu9VyYBxE"), false),
            AccountMeta::new(Pubkey::new_unique(), true),
            AccountMeta::new(Pubkey::new_unique(), false),
            AccountMeta::new(pubkey!("8VAK5Zk2q9F4W9Kxj9K8buaHTvTduPY2KEUPxzD1oJsf"), false),
            AccountMeta::new(pubkey!("2oL6my4QDDCfpgJZX1bZV1NgbmuNptKdgcE8wJm6efgk"), false),
            AccountMeta::new(Pubkey::new_unique(), false),
            AccountMeta::new_readonly(pubkey!("DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263"), false),
            AccountMeta::new_readonly(pubkey!("So11111111111111111111111111111111111111112"), false),
            AccountMeta::new_readonly(pubkey!("JUP6LkbZbjS1jKKwapdHNy74zcZ3tLUZoi5QNyVTaV4"), false),
            AccountMeta::new_readonly(pubkey!("JUP6LkbZbjS1jKKwapdHNy74zcZ3tLUZoi5QNyVTaV4"), false),
            AccountMeta::new_readonly(pubkey!("D8cy77BBepLMngZx6ZukaTff5hCt1HrWyKk3Hnd9oitf"), false),
            AccountMeta::new_readonly(pubkey!("JUP6LkbZbjS1jKKwapdHNy74zcZ3tLUZoi5QNyVTaV4"), false),
        ];
